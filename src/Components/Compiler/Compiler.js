...
export default class Compiler extends Component {
    ...
    const response = await fetch(
      "https://judge0-ce.p.rapidapi.com/submissions",
      {
        ...
        headers: {
          ...
          "x-rapidapi-key": api_key, // Get yours for free at https://rapidapi.com/hermanzdosilovic/api/judge0
  ...
  render() {
    ...
    return (
      <>
        <div className="row container-fluid navtop">
